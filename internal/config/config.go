...
type Config struct {
	...
	ActiveVacationsChannelID string
...
func Load() (Config, error) {
	...
	cfg := Config{
		...
		ActiveVacationsChannelID: strings.TrimSpace(os.Getenv("ACTIVE_VACATIONS_CHANNEL_ID")),
	...
	if cfg.ActiveVacationsChannelID == "" {
		cfg.ActiveVacationsChannelID = "1501256029399285810"
	}
