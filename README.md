...
VACATIONS_COMMAND_CHANNEL_ID=1499669325685198888
...
Команда работает только в канале `1499669325685198888`. Пользователю всё равно нужен доступ к officer-каналу, иначе бот ответит отказом. Успешный ответ команды публичный и появляется в канале, где команда была использована.
